...
class WallPermutation
{
    ...
    public function apply(): Builder
    {
        ...
        ->addPermutation(
            ...
            ->addComponent(new CollisionBoxBlockComponent(true, [new BoxCollision(new Vector3(-4, 0, -4), new Vector3(8, 24, 8))]))
            ->addComponent(new SelectionBoxBlockComponent(true, [new BoxCollision(new Vector3(-4, 0, -4), new Vector3(8, 13, 8))]))
        )->addPermutation(
            Permutation::create()
            ->setCondition("q.block_state('" . StateNames::WALL_CONNECTION_TYPE_NORTH . "') != 0 && q.block_state('" . StateNames::WALL_CONNECTION_TYPE_SOUTH . "') == 0 && q.block_state('" . StateNames::WALL_CONNECTION_TYPE_WEST . "') == 0 && q.block_state('" . StateNames::WALL_CONNECTION_TYPE_EAST . "') == 0")
            ->addComponent(new CollisionBoxBlockComponent(true, [new BoxCollision(new Vector3(-4, 0, -8), new Vector3(8, 24, 12))]))
            ->addComponent(new SelectionBoxBlockComponent(true, [new BoxCollision(new Vector3(-4, 0, -8), new Vector3(8, 13, 12))]))
        )->addPermutation(
            Permutation::create()
            ->setCondition("q.block_state('" . StateNames::WALL_CONNECTION_TYPE_NORTH . "') == 0 && q.block_state('" . StateNames::WALL_CONNECTION_TYPE_SOUTH . "') != 0 && q.block_state('" . StateNames::WALL_CONNECTION_TYPE_WEST . "') == 0 && q.block_state('" . StateNames::WALL_CONNECTION_TYPE_EAST . "') == 0")
            ->addComponent(new CollisionBoxBlockComponent(true, [new BoxCollision(new Vector3(-4, 0, -4), new Vector3(8, 24, 12))]))
            ->addComponent(new SelectionBoxBlockComponent(true, [new BoxCollision(new Vector3(-4, 0, -4), new Vector3(8, 13, 12))]))
        )->addPermutation(
            Permutation::create()
            ->setCondition("q.block_state('" . StateNames::WALL_CONNECTION_TYPE_NORTH . "') == 0 && q.block_state('" . StateNames::WALL_CONNECTION_TYPE_SOUTH . "') == 0 && q.block_state('" . StateNames::WALL_CONNECTION_TYPE_WEST . "') != 0 && q.block_state('" . StateNames::WALL_CONNECTION_TYPE_EAST . "') == 0")
            ->addComponent(new CollisionBoxBlockComponent(true, [new BoxCollision(new Vector3(-4, 0, -4), new Vector3(12, 24, 8))]))
            ...
            Permutation::create()
            ->setCondition("q.block_state('" . StateNames::WALL_CONNECTION_TYPE_NORTH . "') != 0 && q.block_state('" . StateNames::WALL_CONNECTION_TYPE_SOUTH . "') != 0 && q.block_state('" . StateNames::WALL_CONNECTION_TYPE_WEST . "') == 0 && q.block_state('" . StateNames::WALL_CONNECTION_TYPE_EAST . "') == 0")
            ->addComponent(new CollisionBoxBlockComponent(true, [new BoxCollision(new Vector3(-3, 0, -8), new Vector3(6, 24, 16))]))
            ->addComponent(new SelectionBoxBlockComponent(true, [new BoxCollision(new Vector3(-3, 0, -8), new Vector3(6, 13, 16))]))
        )->addPermutation(
            Permutation::create()
            ->setCondition("q.block_state('" . StateNames::WALL_CONNECTION_TYPE_NORTH . "') == 0 && q.block_state('" . StateNames::WALL_CONNECTION_TYPE_SOUTH . "') == 0 && q.block_state('" . StateNames::WALL_CONNECTION_TYPE_WEST . "') != 0 && q.block_state('" . StateNames::WALL_CONNECTION_TYPE_EAST . "') != 0")
            ->addComponent(new CollisionBoxBlockComponent(true, [new BoxCollision(new Vector3(-8, 0, -3), new Vector3(16, 24, 6))]))
            ...
            Permutation::create()
            ->setCondition("q.block_state('" . StateNames::WALL_CONNECTION_TYPE_NORTH . "') != 0 && q.block_state('" . StateNames::WALL_CONNECTION_TYPE_SOUTH . "') == 0 && q.block_state('" . StateNames::WALL_CONNECTION_TYPE_WEST . "') == 0 && q.block_state('" . StateNames::WALL_CONNECTION_TYPE_EAST . "') != 0")
            ->addComponent(new CollisionBoxBlockComponent(true, [new BoxCollision(new Vector3(-8, 0, -8), new Vector3(12, 24, 12))]))
            ->addComponent(new SelectionBoxBlockComponent(true, [new BoxCollision(new Vector3(-8, 0, -8), new Vector3(12, 13, 12))]))
        )->addPermutation(
            Permutation::create()
            ->setCondition("q.block_state('" . StateNames::WALL_CONNECTION_TYPE_NORTH . "') == 0 && q.block_state('" . StateNames::WALL_CONNECTION_TYPE_SOUTH . "') != 0 && q.block_state('" . StateNames::WALL_CONNECTION_TYPE_WEST . "') != 0 && q.block_state('" . StateNames::WALL_CONNECTION_TYPE_EAST . "') == 0")
            ->addComponent(new CollisionBoxBlockComponent(true, [new BoxCollision(new Vector3(-4, 0, -4), new Vector3(12, 24, 12))]))
            ->addComponent(new SelectionBoxBlockComponent(true, [new BoxCollision(new Vector3(-4, 0, -4), new Vector3(12, 13, 12))]))
        )->addPermutation(
            Permutation::create()
            ->setCondition("q.block_state('" . StateNames::WALL_CONNECTION_TYPE_NORTH . "') == 0 && q.block_state('" . StateNames::WALL_CONNECTION_TYPE_SOUTH . "') != 0 && q.block_state('" . StateNames::WALL_CONNECTION_TYPE_WEST . "') == 0 && q.block_state('" . StateNames::WALL_CONNECTION_TYPE_EAST . "') != 0")
            ->addComponent(new CollisionBoxBlockComponent(true, [new BoxCollision(new Vector3(-8, 0, -4), new Vector3(12, 24, 12))]))
            ->addComponent(new SelectionBoxBlockComponent(true, [new BoxCollision(new Vector3(-8, 0, -4), new Vector3(12, 13, 12))]))
        )->addPermutation(
            Permutation::create()
            ->setCondition("q.block_state('" . StateNames::WALL_CONNECTION_TYPE_NORTH . "') != 0 && q.block_state('" . StateNames::WALL_CONNECTION_TYPE_SOUTH . "') == 0 && q.block_state('" . StateNames::WALL_CONNECTION_TYPE_WEST . "') != 0 && q.block_state('" . StateNames::WALL_CONNECTION_TYPE_EAST . "') != 0")
            ->addComponent(new CollisionBoxBlockComponent(true, [new BoxCollision(new Vector3(-8, 0, -8), new Vector3(16, 24, 12))]))
            ->addComponent(new SelectionBoxBlockComponent(true, [new BoxCollision(new Vector3(-8, 0, -8), new Vector3(16, 13, 12))]))
        )->addPermutation(
            Permutation::create()
            ->setCondition("q.block_state('" . StateNames::WALL_CONNECTION_TYPE_NORTH . "') == 0 && q.block_state('" . StateNames::WALL_CONNECTION_TYPE_SOUTH . "') != 0 && q.block_state('" . StateNames::WALL_CONNECTION_TYPE_WEST . "') != 0 && q.block_state('" . StateNames::WALL_CONNECTION_TYPE_EAST . "') != 0")
            ->addComponent(new CollisionBoxBlockComponent(true, [new BoxCollision(new Vector3(-8, 0, -4), new Vector3(16, 24, 12))]))
            ->addComponent(new SelectionBoxBlockComponent(true, [new BoxCollision(new Vector3(-8, 0, -4), new Vector3(16, 13, 12))]))
        )->addPermutation(
            Permutation::create()
            ->setCondition("q.block_state('" . StateNames::WALL_CONNECTION_TYPE_NORTH . "') != 0 && q.block_state('" . StateNames::WALL_CONNECTION_TYPE_SOUTH . "') != 0 && q.block_state('" . StateNames::WALL_CONNECTION_TYPE_WEST . "') != 0 && q.block_state('" . StateNames::WALL_CONNECTION_TYPE_EAST . "') == 0")
            ->addComponent(new CollisionBoxBlockComponent(true, [new BoxCollision(new Vector3(-4, 0, -8), new Vector3(12, 24, 16))]))
            ->addComponent(new SelectionBoxBlockComponent(true, [new BoxCollision(new Vector3(-4, 0, -8), new Vector3(12, 13, 16))]))
        )->addPermutation(
            Permutation::create()
            ->setCondition("q.block_state('" . StateNames::WALL_CONNECTION_TYPE_NORTH . "') != 0 && q.block_state('" . StateNames::WALL_CONNECTION_TYPE_SOUTH . "') != 0 && q.block_state('" . StateNames::WALL_CONNECTION_TYPE_WEST . "') == 0 && q.block_state('" . StateNames::WALL_CONNECTION_TYPE_EAST . "') != 0")
            ->addComponent(new CollisionBoxBlockComponent(true, [new BoxCollision(new Vector3(-8, 0, -8), new Vector3(12, 24, 16))]))
